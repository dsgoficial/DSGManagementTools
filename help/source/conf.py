# -*- coding: utf-8 -*-
#
# DsgManagementTools documentation build configuration file, created by
...
latex_documents = [
  ('index', 'DsgManagementTools.tex', u'DsgManagementTools Documentation',
...
man_pages = [
    ('index', 'TemplateClass', u'DsgManagementTools Documentation',
